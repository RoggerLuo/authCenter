...
module.exports = function (app) {
  ...
  app.all('*', function(req, res, next) {
    ...
    res.header("Access-Control-Allow-Headers", "token, Content-Type, X-Requested-With,Content-Length,Authorization,Accept,Cookie,Cache-Control,Pragma,expire-day");
