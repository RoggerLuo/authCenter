...
const {getSubject,updatePostCount} = require('../subject/dao')
const {controller} = require('../../utils/controller')
const userId = 'c80250ac61534b178ffb9d001f537da7'
module.exports = {
    recommendCreate: controller(['subjectId'],function*({req}){
        
    }),
    getList: controller(['subjectId'],function*({req}){
        const [count,data] = yield dao.getList(req.query)
